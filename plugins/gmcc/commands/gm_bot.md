---
description: Lightweight GMCC workflow (variant bot). Authors a prompt into the current session, enters the kernel's workflow machine, and runs every phase in primary context — the only spawn is the haiku doper briefing.
