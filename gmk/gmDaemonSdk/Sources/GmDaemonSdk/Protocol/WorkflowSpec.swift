...
public enum WorkflowSpec {
    ...
    public static func instructions(variant: BotVariant, phase: Phase) -> String {
        ...
        case .explore:
            ...
            case .bot:
                spawnNote =
                    "Explore IN CONTEXT (no subagents): open your general summary and write the finding rows yourself."
            ...
            case .team:
                spawnNote =
                    "One explorer per methodology, as teammates or a dynamic workflow — script code never writes; the agents hold the pen."
                clarifierNote = "spawn ONE gmcc:clarifier"
            }
            return """
