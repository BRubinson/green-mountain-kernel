    ...
    public static let all: [DopeLevel: DopeLevelSpec] = {
        ...
        let specs: [DopeLevelSpec] = [
            ...
            DopeLevelSpec(
                ...
                parentLevel: .scope,
                parentColumn: "dope_scope_uuid",
                ownedFields: common
            ),
            DopeLevelSpec(
                level: .entity,
                table: "dope_persistence_entity",
                parentLevel: .persistence,
                parentColumn: "dope_persistence_uuid",
            ...
            DopeLevelSpec(
                ...
                parentLevel: .entity,
                parentColumn: "dope_persistence_entity_uuid",
                ownedFields: common.union([
            ...
            DopeLevelSpec(
                ...
                parentLevel: .enumeration,
                parentColumn: "dope_persistence_enum_uuid",
                ownedFields: common
            ),
        ]
