...
///
/// During a session the db is the working source of truth and dumps to the
/// repo; the files become the INPUT only at a boundary — a new session, a new
/// branch, a git merge. Resolution is per-element: files win for anything this
