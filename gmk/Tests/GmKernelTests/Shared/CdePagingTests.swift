...
final class CdePagingWireTests: KernelBackedTestCase {
    ...
    func testExplorationPagesUnionToTheWholeRecord() throws {
        ...
        let pages = try allPages(
            "cde_rpir_explore",
            ["op": .string("get"), "prompt_uuid": .string(fixture.promptUuid)]
        )
    ...
    func testFindingUuidPinsOneBody() throws {
        ...
        let page = try call(
            ...
            [
                "op": .string("get"), "prompt_uuid": .string(fixture.promptUuid),
                "finding_uuid": .string(fixture.findingUuids[7]),
            ]
        )
    ...
    func testClarificationPagesNotesAndStubsThePackage() throws {
        ...
        let pinned = try call(
            ...
            [
                "op": .string("get"), "prompt_uuid": .string(fixture.promptUuid),
                "note_uuid": .string(fixture.noteUuids[3]),
            ]
        )
    ...
    func testCarePackageWindowsTheIntentAndStubsTheRefs() throws {
        ...
        let pages = try allPages(
            "cde_rpir_clarify",
            ["op": .string("package_get"), "prompt_uuid": .string(fixture.promptUuid)]
        )
    ...
    func testArchitectureWindowsTheBodyAndStubsTheChanges() throws {
        ...
        let one = try allPages(
            ...
            [
                "op": .string("get"), "prompt_uuid": .string(fixture.promptUuid),
                "change_uuid": .string(fixture.changeUuids[5]),
            ]
        )
    ...
    func testFileChangesPageThroughEveryRow() throws {
        ...
        let pages = try allPages(
            "cde_prompt",
            ["op": .string("file_changes"), "prompt_uuid": .string(fixture.promptUuid)]
        )
    ...
    func testPromptTextArrivesAsWindows() throws {
        ...
        let pages = try allPages(
            "cde_prompt",
            ["op": .string("load"), "prompt_uuid": .string(fixture.promptUuid)]
        )
    ...
    func testRecordSearchPagesItsHits() throws {
        ...
        let pages = try allPages(
            "cde_rpir_search",
            [
                "scope": .string("exploration"), "query": .string("lorem"),
                "session_uuid": .string(fixture.sessionUuid), "limit": .int(200),
