...
struct WorkflowStripModelTests {
    ...
    private static func workflow(
        ...
        BotWorkflowRow(
            ...
            // No `reconcileGitHead:` — BotWorkflowRow has never carried that
            // field. This argument was here before the reorg and had never
            // compiled anywhere: the app's test target is not part of the
            // package suite and had never been built in CI, so the rot was
            // invisible. Building gmVibes in CI is what surfaced it.
