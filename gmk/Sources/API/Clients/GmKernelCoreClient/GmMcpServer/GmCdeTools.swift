...
enum GmCdeTools {
    ...
    /// Every tool name the roster declares. The runtime half of the
    /// bidirectional name-parity check — the build-time half stops a generated
    /// plugin naming a tool nothing serves, and this answers the reverse
    /// question for a caller that arrives with an unknown name.
    ...
    static func call(
        ...
        return try renderResult(tool: tool, op: op, value: value)
    }
