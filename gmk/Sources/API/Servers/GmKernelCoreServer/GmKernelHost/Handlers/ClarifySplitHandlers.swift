...
enum ClarifyQuestionAddHandler {
    /// Handles a clarify question add request.
    /// - Parameters:
...
enum ClarifyNoteAddHandler {
    /// Handles a clarify note add request.
    /// - Parameters:
    ///   - line: The request payload data.
    ///   - head: The envelope header containing prompt uuid and other routing info.
    ///   - store: The persistence store.
...
enum CarePackageOpenHandler {
    /// Handles a care package open request.
    /// - Parameters:
    ///   - line: The request payload data.
    ///   - head: The envelope header containing prompt uuid and other routing info.
    ///   - store: The persistence store.
...
enum CarePackageRefAddHandler {
    /// Handles a care package ref add request.
    /// - Parameters:
    ///   - line: The request payload data.
    ///   - head: The envelope header containing prompt uuid and other routing info.
    ///   - store: The persistence store.
...
enum CarePackageCompleteHandler {
    /// Handles a care package complete request.
    /// - Parameters:
    ///   - line: The request payload data.
    ///   - head: The envelope header containing prompt uuid and other routing info.
    ///   - store: The persistence store.
...
enum CarePackageGetHandler {
    /// Handles a care package get request.
    /// - Parameters:
    ///   - line: The request payload data.
    ///   - head: The envelope header containing prompt uuid and other routing info.
    ///   - store: The persistence store.
