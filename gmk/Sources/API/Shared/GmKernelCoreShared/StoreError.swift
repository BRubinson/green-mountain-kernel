...
enum StoreError: Error, Sendable {
    ...
    var errorPayload: ErrorPayload {
        ...
        case .summaryAbsent(let entity, let uuid):
            ...
            let hint: String
            switch entity {
            case "exploration": hint = openHint("cde_rpir_explore")
            case "briefing": hint = openHint("cde_rpir_briefing")
            case "review": hint = openHint("cde_rpir_review")
            case "architecture": hint = openHint("cde_rpir_architecture")
            case "clarification": hint = openHint("cde_rpir_clarify")
            default: hint = "\(openHint("cde_rpir_clarify")) or \(openHint("cde_rpir_architecture"))"
            }
            return ErrorPayload(
                code: .summaryAbsent,
