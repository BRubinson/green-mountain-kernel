...
enum VerbRegistry {
    ...
    /// The four pen OPS that ADVANCE the machine, as `tool.op`. Named so the pen
    /// sheet can tell a persona which calls belong to the reader who calibrates
    /// and seals — a statement about how good work gets produced, not a
    /// permission check. Nothing refuses a caller for using one.
    ///
    ...
    /// caller must not follow: these verbs append, so the retry writes a second
    /// row. Read off the roster, never hand-listed, so it cannot drift. The
    /// per-OP answer is the one that matters on a mixed tool and lives on
    /// `CdeOpSpec.isWrite`; this is the whole-tool fallback.
    ...
    static let all: [VerbSpec] = [
        ...
        VerbSpec(.promptList, gm: "gm prompt list", cde: "cde_prompt", role: .read),
        ...
        VerbSpec(.fileChangeList, gm: "gm file-change list", cde: "cde_prompt", role: .read),
        ...
        VerbSpec(.kbiteMawOpen, gm: "gm kbite maw-open", cde: "cde_kbite", role: .record(agentPhases: nil)),
        VerbSpec(.kbiteDigest, gm: "gm kbite digest", cde: "cde_kbite", role: .record(agentPhases: nil)),
        VerbSpec(.kbiteGet, gm: "gm kbite get", role: .read),
        VerbSpec(.kbiteFileGet, gm: "gm kbite file-get", role: .read),
        VerbSpec(.kbiteSearch, gm: "gm kbite search", cde: "cde_kbite", role: .read),
        ...
        // ── Search ───────────────────────────────────────────────────────
        VerbSpec(.catalogSearch, gm: "gm catalog search", cde: "cde_session", role: .read),
        ...
        VerbSpec(.clarifyGet, gm: "gm clarify get", cde: "cde_rpir_clarify", role: .read),
        ...
        VerbSpec(.carePackageGet, gm: "gm clarify package-get", cde: "cde_rpir_clarify", role: .read),
        ...
        VerbSpec(.archGet, gm: "gm arch get", cde: "cde_rpir_architecture", role: .read),
        ...
        VerbSpec(.exploreGet, gm: "gm explore get", cde: "cde_rpir_explore", role: .read),

        // ── Review machine ───────────────────────────────────────────────
        VerbSpec(.reviewOpen, gm: "gm review open", cde: "cde_rpir_review", role: .record(agentPhases: [.review])),
        VerbSpec(
            .reviewFindingAdd,
        ...
        VerbSpec(.reviewGet, gm: "gm review get", cde: "cde_rpir_review", role: .read),
        ...
        VerbSpec(.dopeSearch, gm: "gm dope search", cde: "cde_dope", role: .read),
        ...
        VerbSpec(.dopeWriteRepo, gm: "gm dope write-repo", cde: "cde_dope", role: .record(agentPhases: nil)),
